...
#ifdef HAVE_AWS_S3_S3CLIENT_H
    if (!BESCatalogList::TheCatalogList()->ref_catalog("s3")) {
        BESCatalogList::TheCatalogList()->add_catalog(new BESS3Catalog("s3"));
    }
#endif
...
#ifdef HAVE_AWS_S3_S3CLIENT_H
    BESCatalogList::TheCatalogList()->deref_catalog("s3");
