...
class HDF5RequestHandler:public BESRequestHandler {
  public:
    ...
    static void set_default_add_unlimited_dimension_dap4(bool flag) { _add_unlimited_dimension_dap4 = flag;}
  ...
  private:
    ...
    static bool _enable_geotiff;
    static std::string _geotiff_vol_plugin_path;
